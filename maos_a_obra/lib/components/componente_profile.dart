...
class ComponentProfile extends StatefulWidget {
  final String nome;
  final String user;
  ...
  @override
  _ComponentProfileState createState() => _ComponentProfileState();
}

class _ComponentProfileState extends State<ComponentProfile> {
  @override
